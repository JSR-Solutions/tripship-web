                        ...
                        <div className='header-main31'>
                            ...
                            <div className='dub-header-main'>
                                <div className='header-main33'>
                                    <ul>
                                        <li><FiPhone /> <a href="tel:+91-7894561230" >+91-7894561320</a></li>
                                        <li><FiPhone /> <a href="tel:+91-7894561230" >+91-7894561320</a></li>
                                        <li><FiMail /> <a href="mailto:jsrsolution.work@gmail.com" >tripship.travel@gmail.com</a></li>
                                    </ul>
                                </div>
                                <div className='header-main34'>
                                    <ul>
                                        <Link className='deconone' to='/' style={isActive(history, '/')} onClick={changeScreen}><li>Home</li></Link>
                                        <Link className='deconone' to='/musafirrana/packages' style={isActive(history, '/musafirrana/packages')} onClick={changeScreen}><li>Backpacking Trip</li></Link>
                                        ...
                                        <Link className='deconone' to='/contact-us' style={isActive(history, '/contact-us')} onClick={changeScreen}><li>Contact Us</li></Link>
                                        <Link className='deconone' to='/sign-up' style={isActive(history, '/sign-us')} onClick={changeScreen}><li>Backpacking Trip</li></Link>
                                        <Link className='deconone' to='/sign-up' style={isActive(history, '/sign-us')} onClick={changeScreen}><li>Trek</li></Link>
                                    </ul>
                                </div>
                            </div>
                        </div>
